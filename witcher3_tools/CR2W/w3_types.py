...
def loadProps(self, args):
    ...
    if hasattr(args[0], "More"):
        PROPS = args[0].More
    if PROPS is None:
        if hasattr(args[0], "theName") and hasattr(args[0], "theType"):
            PROPS = [args[0]]
        else:
            log.warning("loadProps called with unsupported arg type: %s", type(args[0]).__name__)
            return
    ...
    for arg in PROPS:
        if arg.theType in v_types:
            ...
            if index_obj is not None:
                name_value = getattr(index_obj, "String", None)
                if name_value is None and hasattr(index_obj, "ToString"):
                    try:
                        name_value = index_obj.ToString()
                    except Exception:
                        name_value = None
...
class Entity(base_w3): 
    ...
    def from_json(cls, data):
        if "MovingPhysicalAgentComponent" in data and isinstance(data["MovingPhysicalAgentComponent"], dict):
            ...
            data.setdefault("MovingPhysicalAgentComponent", {})
        appearances = data.get("appearances", [])
        if appearances:
            data["appearances"] = list(map(CEntityAppearance.from_json, appearances))
        else:
            data["appearances"] = []
        return cls(**data)
...
class CEntityAppearance(base_w3):
    def __init__(self, isJson = False, *args):
        super(CEntityAppearance, self).__init__()
        self.name = "" # Type="CName" />
        self.voicetag = None #  Type="CName" />
        self.appearanceParams = [] # Type="array:2,0,ptr:CEntityTemplateParam" />
        self.useVertexCollapse = None #" Type="Bool" />
        self.usesRobe = None #" Type="Bool" />
        self.wasIncluded = None #" Type="Bool" />
        self.includedTemplates = [] #new List<ModelEnt>()# <property Name="includedTemplates" Type="array:2,0,handle:CEntityTemplate" />
        self.collapsedComponents = None # Type="array:2,0,CName" />
        loadJSON(self, args) if isJson else loadProps(self, args)
        
    @classmethod
    def from_json(cls, data):
        return cls(True, data)

class CEquipmentDefinition(object):
    def __init__(self, *args):
        super(CEquipmentDefinition, self).__init__()
        self.wasIncluded = None #" Type="Bool" />
        self.entries = None #" Type="array:2,0,ptr:CEquipmentDefinitionEntry" />
        loadProps(self, args)

class CEquipmentDefinitionEntry(object):
    def __init__(self, *args):
        super(CEquipmentDefinitionEntry, self).__init__()
        self.category = None # Type="CName" />
        self.defaultItemName = None # Type="CName" />
        self.initializer = None # Type="ptr:IEquipmentInitializer" />
        loadProps(self, args)

class CEquipmentInitializerUniform(object):
    def __init__(self, *args):
        super(CEquipmentInitializerUniform, self).__init__()
        self.itemName = None # Type="CName" />
        self.minCount = None # Type="Uint32" />
        self.maxCount = None # Type="Uint32" />
        loadProps(self, args)

class CEquipmentInitializerRandom(object):
    def __init__(self, *args):
        super(CEquipmentInitializerRandom, self).__init__()
        loadProps(self, args)

class CInventoryDefinition(object):
    """Inventory definition containing a list of inventory entries."""
    def __init__(self, *args):
        super(CInventoryDefinition, self).__init__()
        self.wasIncluded = None # Type="Bool" />
        self.entries = None # Type="array:2,0,ptr:CInventoryDefinitionEntry" />
        loadProps(self, args)

class CInventoryDefinitionEntry(object):
    """Single inventory item entry."""
    def __init__(self, *args):
        super(CInventoryDefinitionEntry, self).__init__()
        self.category = None # Type="CName" />
        self.item = None # Type="CName" /> (legacy / optional)
        self.quantity = None # Type="Uint32" />
        self.quantityMin = None # Type="Uint32" />
        self.quantityMax = None # Type="Uint32" />
        self.probability = None # Type="Float" />
        self.isMount = None # Type="Bool" /> (true = auto-mount to slot)
        self.isLootable = None # Type="Bool" />
        self.initializer = None # Type="ptr:IInventoryInitializer" />
        loadProps(self, args)

class CInventoryInitializerUniform(object):
    """Uniform inventory initializer - applies same setup to all."""
    def __init__(self, *args):
        super(CInventoryInitializerUniform, self).__init__()
        self.itemName = None # Type="CName" />
        self.minCount = None # Type="Uint32" />
        self.maxCount = None # Type="Uint32" />
        loadProps(self, args)

class CInventoryInitializerRandom(object):
    """Random inventory initializer."""
    def __init__(self, *args):
        super(CInventoryInitializerRandom, self).__init__()
        loadProps(self, args)


#################

# APPARANCE CLASSES END

##############
class EntitySlot(object):
    """docstring for EntitySlot."""
    def __init__(self, isJson = False, *args):
        super(EntitySlot, self).__init__()
        self.wasIncluded = None #" Type="Bool" />
        self.name = None #" Type="CName" />
        self.componentName = None #" Type="CName" />
        self.boneName = None #" Type="CName" />
        self.transform = None #" Type="EngineTransform" />
        self.freePositionAxisX = None #" Type="Bool" />
        self.freePositionAxisY = None #" Type="Bool" />
        self.freePositionAxisZ = None #" Type="Bool" />
        self.freeRotation = None #" Type="Bool" />
        loadJSON(self, args) if isJson else loadProps(self, args)
        if isJson:
            self.wasIncluded = _coerce_bool(self.wasIncluded, False)
            self.freePositionAxisX = _coerce_bool(self.freePositionAxisX, False)
            self.freePositionAxisY = _coerce_bool(self.freePositionAxisY, False)
            self.freePositionAxisZ = _coerce_bool(self.freePositionAxisZ, False)
            self.freeRotation = _coerce_bool(self.freeRotation, False)
