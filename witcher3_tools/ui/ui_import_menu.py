...
class WITCH_MT_Menu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.separator()
        layout.operator(ButtonOperatorImportVoice.bl_idname, text="Voiceline Pair (.cr2w/.dat)", icon='SPEAKER')
...
class WITCH_MT_Menu_witcher_2(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator(ButtonOperatorImportVoice.bl_idname, text="Voiceline Pair (.dat/.mp2)", icon='SPEAKER')
        layout.separator()
        layout.operator(WITCH_OT_w2L.bl_idname, text="Layer (.w2l)", icon='SPHERE')
        layout.operator(WITCH_OT_w2w.bl_idname, text="World (.w2w)", icon='WORLD_DATA')
